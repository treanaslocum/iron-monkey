<template>
  <div>
    ...
    <section class="flex flex-col w-full items-center">
      <p class="mb-2 uppercase font-bold text-sm sm:text-xl text-center">What we do</p>
    ...
    <section class="mb-24 mt-16 p-16">
      ...
      <div class="flex justify-center sm:space-x-28  flex-wrap">
        <div class="mb-16 flex items-center sm:w-1/3">
          <h3 class="mr-4 text-6xl">|</h3>
          <div class="">
            <h2 class="mb-4 sm:text-2xl text-xl  font-semibold">Brand identities that last.</h2>
        ...
        <div class="mb-16 flex items-center sm:w-1/3">
          ...
          <div class="">
            <h2 class="mb-4 sm:text-2xl text-xl  font-semibold">Design to simplify.</h2>
      ...
      <div class="flex justify-center sm:space-x-28  flex-wrap">
        ...
        <div class="mb-16 flex items-center sm:w-1/3">
          <h3 class="mr-4 text-6xl">|</h3>
          <div class="">
            <h2 class="mb-4 sm:text-2xl text-xl  font-semibold">Building amazing websites.</h2>
        ...
        <div class="mb-16 flex items-center sm:w-1/3">
          <h3 class="mr-4 text-6xl">|</h3>
           <div class="">
            <h2 class="mb-4 sm:text-2xl text-xl  font-semibold">Forward thinking.</h2>
    ...
    <section class="sm:ml-18 ml-16">
      ...
      <div class="flex sm:flex-nowrap flex-wrap sm:ml-0 mt-24">
        <div class="sm:w-1/4	sm:mr-32">
          <h3 class="sm:text-2xl text-xl font-semibold mb-6">Global perspective</h3>
          <p class="sm:text-xl">We have members and collaborators working together from the United States, United Kingdom and Canada providing a valuable global perspective on our work.</p>
        </div>
        <div class="sm:w-1/4 sm:mt-0 mt-8 sm:mr-32">
          <h3 class="sm:text-2xl text-xl font-semibold mb-6">We’re niche</h3>
          <p class="sm:text-xl">We work primarily with SMEs who work in the finance, restaurant, legal, cleaning, property, healthcare, transport, and beauty sectors.</p>
        </div>
        <div class="sm:w-1/4 sm:mt-0 mt-8">
          <h3 class="sm:text-2xl text-xl font-semibold mb-6">Dedicated teams</h3>
          <p class="sm:text-xl">We have focused teams dedicated to each project. Throughout the project, you will have a point of contact to guide you through the project lifecycle.</p>
        </div>
      </div>
      <div class="flex sm:flex-nowrap flex-wrap sm:ml-0 mt-8 sm:mt-24">
        <div class="sm:w-1/4	sm:mr-32">
          <h3 class="sm:text-2xl text-xl font-semibold mb-6">Weekly sessions</h3>
          <p class="sm:text-xl">You can expect to have a constant line of communication with your dedicated team and weekly calls to review progress and updates.</p>
        </div>
        <div class="sm:w-1/4 sm:mt-0 mt-8 sm:mr-32">
          <h3 class="sm:text-2xl text-xl font-semibold mb-6">Collaborative effort</h3>
          <p class="sm:text-xl">It’s a collaborative effort that requires focus from both sides. To ensure the best results, we expect clients to dedicate a point of contact to be actively involved with the project.</p>
        </div>
        <div class="sm:w-1/4 sm:mt-0 mt-8">
          <h3 class="sm:text-2xl text-xl font-semibold mb-6">Well defined client fit</h3>
    ...
    <section class="mt-24 sm:ml-18 ml-16">
      ...
      <div class="sm:ml-64">
        <div class="flex flex-wrap lg:ml-96 md:ml-24">
          <div class="mb-16 sm:w-1/3 md:w-3/4">
            <h3 class="sm:text-2xl text-xl font-semibold">Branding</h3>
          ...
          <div class="mb-16 sm:w-2/4">
            <h3 class="sm:text-2xl text-xl font-semibold">Discovery</h3>
        ...
        <div class="flex flex-wrap lg:ml-96 md:ml-24">
          <div class="mb-16 sm:w-1/3 md:w-3/4 w-1/2">
            <h3 class="sm:text-2xl text-xl font-semibold">Design</h3>
            <p class="sm:text-xl text-base">&#8211; Web design</p>
          </div>
            
          <div class="mb-16 sm:w-2/4">
            <h3 class="sm:text-2xl text-xl font-semibold">Engineering</h3>
     ...
     <!-- <section class="flex flex-col mt-36 mb-36 pt-20 pb-20 w-full items-center">
      ...
      <div class="flex sm:flex-nowrap md:flex-wrap flex-wrap mt-16 justify-center p-8 sm:p-20">
        <div class="shadow-xl sm:w-2/5 w-full p-14 text-center rounded-md bg-white">
          <p class="mb-4 text-2xl font-semibold">Simple</p>
          <p class="mb-6">We will create a landing page website.</p>
   ...
   <section class="mt-24 sm:ml-40 ml-12">
      ...
      <div>
        <p class="text-xl font-semibold">How much does branding cost?</p>
        <p class="w-5/6">Every branding project's requirements differ depending on what each client's needs are; therefore, the cost of branding will vary.</p>
      </div>
      <div class="mt-8">
        <p class="text-xl font-semibold">How much does a website cost?</p>
        <p class="w-5/6">Every website is built to meet the needs of the individual customer; therefore, the cost of a new website will vary depending on how many pages and features you require.</p>
      </div>
       <div class="mt-8">
      ...
      <div class="mt-8">
        ...
        <p class="w-5/6">No! We have clients all over the world and communicate with them over email and Zoom.</p>
      </div>
       <div class="mt-8">
      ...
      <div class="mt-8">
        ...
        <p class="w-5/6">No, the development of your website doe not include monthly SEO. All content (images, text and videos) will be seen by Google but does not mean your website will rank number 1. To increase your organic search position on Google, we recommend monthly SEO services from a team of professionals.</p>
      </div>
      <div class="mt-8">
        <p class="text-xl font-semibold">Who writes the website text?</p>
        <p class="w-5/6">We encourage that you write and supply all of the text that you want on the website. After all, you know your business best. If you need some support with this task we can supply a copywriter for you to rework your copy, or create original content at $25 per hour.</p>
      </div>
      <div class="mt-8">
        <p class="text-xl font-semibold">How do we get started?</p>
        <p class="w-5/6">Contact us via email at ironmonkeystudio702@gmail.com with your project requirements and a link to your existing website, or feel free to book a zoom call to discuss further and we can provide an estimate.</p>
      </div>
    </section>

    <section class="p-16 mt-24 flex flex-col justify-center items-center">
      <h2 class="font-medium text-2xl sm:text-4xl text-center">Have a project in mind? <br> Let’s get to work.</h2>
...
export default {
  ...
  head () {
    return {
      title: "Services - Iron Monkey Studio",
      meta: [
