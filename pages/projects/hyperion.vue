<template>
  <div>
    ...
    <section class="flex justify-center">
      <div class="mr-16 select-none font-semibold flex items-center justify-center">
        <p class="text-gray-300">&larr;</p>
        <p class="text-gray-300">Previous Project</p>
      </div>

      <NuxtLink to="./reflection-beauty" class="font-semibold flex items-center justify-center">
        <p>Next Project</p>
        <p>&rarr;</p>
      </NuxtLink>
    ...
    <section>
      <div class="flex sm:flex-row flex-col  m-16">
        <div class="sm:w-2/4 w-full mr-16">
          <img class="mb-8" src="~/assets/images/hyperion-home.png">
          <img class="mb-8" src="~/assets/images/hyperion-search_results.png">
          <img class="mb-8" src="~/assets/images/hyperion-brand_identity.png">
        </div>
        <div class="sm:w-2/4 w-full">
          <h1 class="mb-8 text-5xl font-semibold">Hyperion Real Estate <br><span class="text-xl font-light">Branding & Web Design</span></h1>
          <div>
...
export default {
  ...
  head () {
    return {
      title: "Hyperion Real Estate - Iron Monkey",
      meta: [
