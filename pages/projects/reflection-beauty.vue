    ...
    <section>
      <div class="flex sm:flex-row flex-col  m-16">
        <div class="sm:w-2/4 w-full mr-16">
          <img class="mb-8" src="~/assets/images/reflection-home.png">
          <img class="mb-8" src="~/assets/images/reflection-product.png">
          <img class="mb-8" src="~/assets/images/reflection-shop-all.png">
        </div>
