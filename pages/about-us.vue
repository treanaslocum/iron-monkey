<template>
  <div>
    ...
    <section class="flex flex-col mt-36 w-full items-center justify-center">
      ...
      <p class="mb-24 sm:w-1/2 w-2/3 text-dark-gray font-light text-lg sm:text-xl text-center">Today we're a small team of skilled designers, web developers, and storytellers leveraging the power of today's technologies to create powerful experiences for small businesses around the world.</p>
    </section>
